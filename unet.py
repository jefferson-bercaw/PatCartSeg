...
def build_unet(model_depth):
    ...
    if model_depth == 3:
        ...
        outputs = layers.Conv2D(filters=2, kernel_size=1, padding="same", activation="sigmoid")(u5)
        ...
        outputs = layers.Conv2D(filters=4, kernel_size=1, padding="same", activation="sigmoid")(u11)
...
if __name__ == "__main__":
    unet_model = build_unet(model_depth=6)
    unet_model.summary()
